...
public class Serializacja { /* aby moc dokonac serializacji(zapisania obiektu do pliku) trzeba zaimplementowac w klasie
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (!(temp = scn.nextLine()).equals("exit")) {
            ...
            } else if (temp.equals("read")) { // deserializacja
                ObjectInputStream ois = new ObjectInputStream(new FileInputStream(f));
                lista = (List<Cat>) ois.readObject();
            } else if (temp.equals("write")) { // serializacja
